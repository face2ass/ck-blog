...
![](/images/image_grid_2.png)

_注：A左乘B的结果为AB，右乘为BA_

但是平移操作通常用向量加法表示，如下：

![](/images/image_grid_3.png)

为了用一个矩阵表示仿射变换（即同时表示线性映射和平移），于是引入了齐次坐标，把二维矩阵A和平移向量并入一个三维增广矩阵。用数学来解释该过程的话：

一个对向量![{\vec  {x}}](/images/image_grid_4.png)平移![{\vec  {b}}](/images/image_grid_5.png)，与旋转放大缩小![ A](/images/image_grid_6.png)的仿射映射为![{\vec  {y}}=A{\vec  {x}}+{\vec  {b}}](/images/image_grid_7.png)

上式在齐次坐标系中，等价于下面的式子

![{\begin{bmatrix}{\vec  {y}}\\1\end{bmatrix}}={\begin{bmatrix}A&{\vec  {b}}\ \\0,\ldots ,0&1\end{bmatrix}}{\begin{bmatrix}{\vec  {x}}\\1\end{bmatrix}}](/images/image_grid_8.png)

到本例中，即

![](/images/image_grid_9.png)
...
![](/images/image_grid_13.png)

可得

![](/images/image_grid_14.png)
